/**
 * Tipovi za FT-Logistika frontend
 * 
 * Prošireni prema Luceed ERP API poljima.
 */
...
export interface NalogHeader {
  ...
  raspored: string | null  // datum isporuke
...
export interface NalogListItem {
  nalog_prodaje_uid: string
  broj: number | null
  datum: string | null
...
export interface Route {
  ...
  stops: RouteStop[]
  /** Polyline duž cesta [[lat, lng], ...] za prikaz na karti */
